...
\begin{tabular}{llccc}
 ...
 \midrule
 \textsc{MLE (Bigrams)} & & & NA & NA \\
 \textsc{MLE (Trigrams)} & & & NA & NA \\
 \textsc{Laplace (Bigrams)} & & & 296.877 & 4.59 \\
 \textsc{Laplace (Trigrams)} & & & 398.745 & 11.859 \\
\textsc{Witten-Bell (Bigrams)} & & & 215.055 & 3.59 \\
\textsc{Witten-Bell (Trigrams)} & & & 368.696 & 5.24 \\
